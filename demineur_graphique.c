//gcc -Wall -Wextra -fsanitize=address,undefined -g -o demineur ELT.c ARBRE.c demineur_graphique.c -lm -Iinclude -lSDL2
...
void dessiner_matrice_utilisateur(char** visible, char** plateau){
    printf("    ");
...
void dessiner_matrice(char** mat, int taille){
  printf("    ");
...
void dessiner_zero(SDL_Renderer *renderer,int x, int y){
    ...
    SDL_SetRenderDrawColor(renderer, 75, 75, 75, 255);//gris
...
void dessiner_un(SDL_Renderer *renderer,int x, int y){
    ...
    SDL_RenderDrawLine(renderer,x+30,y+5,x+30,y+35);
    SDL_RenderPresent(renderer);
}
...
void dessiner_deux(SDL_Renderer *renderer,int x, int y){
    ...
    SDL_RenderDrawLine(renderer,x+8,y+5,x+30,y+5);
    SDL_RenderDrawLine(renderer,x+30,y+5,x+30,y+20);
    SDL_RenderDrawLine(renderer,x+8,y+20,x+30,y+20);
    SDL_RenderDrawLine(renderer,x+8,y+20,x+8,y+35);
...
void dessiner_quatre(SDL_Renderer *renderer,int x, int y){
    ...
    SDL_SetRenderDrawColor(renderer, 75, 75, 75, 255);//gris
    SDL_RenderFillRect(renderer, &rect);
    SDL_SetRenderDrawColor(renderer, 33, 11, 144, 255);//bleu foncé
...
void dessiner_cinq(SDL_Renderer *renderer,int x, int y){
    ...
    SDL_SetRenderDrawColor(renderer, 75, 75, 75, 255);//gris
    SDL_RenderFillRect(renderer, &rect);
    SDL_SetRenderDrawColor(renderer, 144, 11, 33, 255);//rouge foncé
    SDL_RenderDrawLine(renderer,x+8,y+5,x+30,y+5);
    SDL_RenderDrawLine(renderer,x+8,y+5,x+8,y+20);
    SDL_RenderDrawLine(renderer,x+8,y+20,x+30,y+20);
    SDL_RenderDrawLine(renderer,x+30,y+20,x+30,y+35);
    SDL_RenderDrawLine(renderer,x+8,y+35,x+30,y+35); 
    SDL_RenderPresent(renderer);
}
...
void dessiner_six(SDL_Renderer *renderer,int x, int y){
    ...
    SDL_SetRenderDrawColor(renderer, 75, 75, 75, 255);//gris
    SDL_RenderFillRect(renderer, &rect);
    SDL_SetRenderDrawColor(renderer, 31, 172, 163, 255);//cyan
    SDL_RenderDrawLine(renderer,x+8,y+5,x+30,y+5);
    SDL_RenderDrawLine(renderer,x+8,y+5,x+8,y+35);
    SDL_RenderDrawLine(renderer,x+8,y+20,x+30,y+20);
    SDL_RenderDrawLine(renderer,x+30,y+20,x+30,y+35);
    SDL_RenderDrawLine(renderer,x+8,y+35,x+30,y+35); 
    SDL_RenderPresent(renderer);
